...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["search"])) {
    ...
    $sql = "SELECT * FROM students WHERE name LIKE '%$search_escaped%' OR email LIKE '%$search_escaped%' OR student_id LIKE '%$search_escaped%'";
} else {
...
<title>Student List — AR TECH SOLUTION</title>
    ...
    <div class="table-card">
        <div style="overflow-x: auto;">
            <table>
                <thead>
                    <tr>
                        <th>ID</th><th>Photo</th><th>Issue Date</th><th>Course Start</th><th>Course End</th>
                        <th>Name</th><th>Father's Name</th><th>Mother's Name</th><th>DOB</th><th>Phone</th>
                        <th>Gender</th><th>Marital Status</th><th>Occupation</th><th>Religion</th><th>Country</th>
                        <th>Present Address</th><th>Permanent Address</th><th>City</th><th>District</th>
                        <th>ID Type</th><th>ID Number</th><th>Course Category</th><th>Course Fee</th>
                        <th>Paid Fee</th><th>Due Fee</th><th>Email</th><th>Action</th>
                    </tr>
                </thead>
                <tbody>
                <?php if ($result->num_rows > 0): ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><img src="uploads/<?php echo htmlspecialchars($row["profile_image"]); ?>" alt="Profile"></td>
                            ...
                            <td><a href="edit.php?student_id=<?php echo urlencode($row["student_id"]); ?>" class="edit-btn">Edit</a></td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr><td colspan="28" style="text-align: center;">No student records found.</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
