...
<title>Certificate List — AR TECH SOLUTION</title>
...
<main class="main" id="mainContent">
    <div class="section-title">📜 Uploaded Certificates</div>
    ...
    <div class="search-card">
        <form method="GET" action="">
            ...
            <?php if (!empty($search)): ?>
                <a href="certificate_list.php" class="clear-btn">Clear</a>
            <?php endif; ?>
        </form>
    </div>
    ...
    <div class="table-card">
        <div style="overflow-x: auto;">
            <table>
                <thead>
                    <tr>
                        <th>ID</th><th>Student ID</th><th>Name</th><th>Certificate</th><th>Uploaded At</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if ($result && $result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><a href="certificates/<?php echo urlencode($row['certificate_file']); ?>" target="_blank" class="certificate-link">View</a></td>
                                <td><?php echo $row['uploaded_at']; ?></td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="5" class="empty-row">No certificates found.<?php echo !empty($search) ? ' Try a different search.' : ''; ?></td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
