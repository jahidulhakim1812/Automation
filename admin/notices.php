...
<aside class="sidebar" id="sidebar">
    ...
    <div class="menu-group"><div class="menu-toggle">💵 Payment ▾</div><div class="submenu"><a href="invoice_pos.php">🧾 POS Invoice</a><a href="invoice_list.php">📋 Invoice List</a><a href="invoice.php">Print Invoice</a><a href="view_invoice.php">Verify Invoice</a><a href="input_payment.php">Add Payment</a><a href="payment_due.php">Due Payment List</a></div></div>
    <div class="menu-group"><div class="menu-toggle">📆 Attendance ▾</div><div class="submenu"><a href="attendance.php">Take Attendance</a><a href="attendance_report.php">View Report</a></div></div>
    ...
    <a href="notices.php" class="active">📢 Send Notices</a>
</aside>
