...
$sql = "SELECT student_id, name, email, course_fee, paid_fee FROM students WHERE course_category = ?";
...
<title><?php echo htmlspecialchars($category); ?> Students — AR TECH SOLUTION</title>
...
<main class="main" id="mainContent">
    <div class="section-title">🎓 <?php echo htmlspecialchars($category); ?> Students</div>
    ...
    <div class="table-card">
        ...
        <?php else: ?>
            <div class="no-data">📭 No students enrolled in <?php echo htmlspecialchars($category); ?>.</div>
        <?php endif; ?>
    </div>
</main>
