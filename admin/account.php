...
<title>Account Overview — AR TECH SOLUTION</title>
...
.form-card button:hover { opacity: .85; }
...
<main class="main" id="mainContent">
    ...
    <div class="stats-container">
        ...
        <div class="stat-card" style="--card-accent:#2980b9">
            <h3>Total Paid Fee</h3>
            <p>৳ <?php echo number_format($totalPaidFee, 2); ?></p>
        </div>
        <div class="stat-card" style="--card-accent:#e74c3c">
            <h3>Total Due Fee</h3>
    ...
    <div class="chart-card">
        <div class="chart-title">📊 Fee Breakdown (Student Course Fees)</div>
...
new Chart(ctx, {
    ...
    options: {
        ...
        plugins: {
            ...
            tooltip: { backgroundColor: 'rgba(10,15,35,0.95)', borderColor: '#00e5c8', borderWidth: 1 }
        },
        scales: {
            y: { 
                beginAtZero: true,
