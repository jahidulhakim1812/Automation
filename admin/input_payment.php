...
<title>Add Payment — AR TECH SOLUTION</title>
...
/* Force white text inside info-card */
.info-card, .info-card .student-details, .info-card .student-details p,
.info-card .fee-table td, .info-card .payment-form input,
.info-card .message, .info-card h2 {
...
.payment-form button:hover { opacity: .85; }
...
<main class="main" id="mainContent">
    <div class="info-card">
        ...
        <!-- Search Form -->
        <div class="search-card" style="margin-bottom:20px; padding:0; background:transparent; backdrop-filter:none;">
            <form method="POST">
        ...
        <?php if ($student): ?>
            ...
            <table class="fee-table">
                <tr><td>Course Fee</td><td>৳ <?php echo number_format($student['course_fee'], 2); ?></td></tr>
                <tr><td>Paid Fee</td><td>৳ <?php echo number_format($student['paid_fee'], 2); ?></td></tr>
                <tr><td>Due Fee</td><td style="color: var(--accent3) !important;">৳ <?php echo number_format($student['course_fee'] - $student['paid_fee'], 2); ?></td></tr>
            </table>
