...
<title>View Videos — AR TECH SOLUTION</title>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="video-card">
                    ...
                    <div class="video-info">
                        ...
                        <div class="video-description"><?php echo nl2br(htmlspecialchars($row['description'])); ?></div>
                    </div>
                </div>
            <?php endwhile; ?>
        </div>
    <?php else: ?>
        <div class="no-data">📭 No videos uploaded yet. Click "Upload Video" to add some.</div>
    <?php endif; ?>
</main>
