...
<title>Ongoing Students — AR TECH SOLUTION</title>
...
<main class="main" id="mainContent">
    <div class="section-title">⏳ Ongoing Students</div>
    ...
    <div class="table-card">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="status-ongoing">⏳ <?php echo ucfirst($row['course_status']); ?></span></td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
        ...
        <?php else: ?>
            <div class="no-data">⏳ No ongoing students found.</div>
        <?php endif; ?>
    </div>
</main>
