...
<head>
    ...
    .logout-btn:hover {
      ...
      transform: scale(1.05);
        ...
        .search-button { padding: 8px 12px; border: none; background: #3498db; color: #fff; border-radius: 4px; cursor: pointer; }
    ...
    <?php if ($result->num_rows > 0): ?>
        <table>
            ...
            <tr>
                ...
                <td><b style="color:green;"><?= ucfirst($row['course_status']) ?></b></td>
            </tr>
            <?php endwhile; ?>
        </table>
    <?php else: ?>
        <p class="error">❌ No students have finished their course yet.</p>
    <?php endif; ?>
</div>
