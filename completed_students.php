...
if (isset($_GET['category']) && !empty(trim($_GET['category']))) {
    ...
    $sql = "SELECT student_id, name, email, phone_number, course_status, course_category
            FROM students
            WHERE course_status = 'finished' AND course_category LIKE '%$search_category%'
            ORDER BY name ASC";
} else {
    $sql = "SELECT student_id, name, email, phone_number, course_status, course_category
            FROM students
            WHERE course_status = 'finished'
            ORDER BY name ASC";
}
...
<title>Completed Students — AR TECH SOLUTION</title>
...
<main class="main" id="mainContent">
    <div class="section-title">🎓 Completed Students</div>
    ...
    <div class="table-card">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="status-completed">✓ <?php echo ucfirst($row['course_status']); ?></span></td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
        ...
        <?php else: ?>
            <div class="no-data">❌ No students have finished their course yet.</div>
        <?php endif; ?>
    </div>
</main>
