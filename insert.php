...
<main class="main" id="mainContent">
    <div class="form-card">
        ...
        <form action="insert.php" method="POST" enctype="multipart/form-data">
            <div class="form-grid">
                <div class="form-field"><input type="number" name="student_id" placeholder="Student ID" required></div>
                ...
                <div class="form-field"><input type="number" name="paid_fee" placeholder="Paid Fee" required></div>
